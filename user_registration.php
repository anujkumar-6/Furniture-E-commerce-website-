            ...
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        placeholder="Enter your username" autocomplete="off" required="requried" name="user_username">
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        placeholder="Enter your email" autocomplete="off" required="requried" name="user_email">
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="file" id="user_image" class="form-control" 
                         required="requried" name="user_image">
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        placeholder="Enter your password" autocomplete="off" required="requried" name="user_password">
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        placeholder="Confirm password" autocomplete="off" required="requried" name="conf_user_password">
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        placeholder="Enter your address" autocomplete="off" required="requried" name="user_address">
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        placeholder="Enter your mobile number" autocomplete="off" required="requried" name="user_contact">
                    </div>
...
if(isset($_POST['user_register'])){
    ...
    user_mobile) values ('$user_username', '$user_email', '$hash_password', '$user_image', '$user_ip','$user_address',
    '$user_contact')";
